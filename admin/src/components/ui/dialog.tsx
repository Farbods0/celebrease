...
function DialogContent({
    ...
    // Radix logs a warning when neither aria-describedby nor a DialogDescription
    // child is provided. Explicitly defaulting aria-describedby to undefined opts
    // out of the warning while keeping the dialog accessible. Consumers that want
    // a description can still pass aria-describedby (or render a DialogDescription).
