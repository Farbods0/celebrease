...
const FAQ_GROUPS: { cat: Exclude<CatKey, "all">; icon: string; title: string; items: FaqItem[] }[] = [
    ...
    },
    {
        ...
        title: "Kits & Rentals",
        items: [
            { q: "What's inside a CeleBrease kit?", a: "Each kit contains 10-25 hand-selected décor pieces curated by our in-house design team for one specific holiday. You'll also find a styling card with room-by-room placement guidance and a pre-paid return shipping label. Silver Kits focus on signature pieces; Premium and Platinum Kits add statement lighting, textiles, and seasonal accents." },
