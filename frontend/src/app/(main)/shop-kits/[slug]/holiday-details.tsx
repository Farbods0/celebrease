    ...
    return (
        <>
            ...
            >
                ...
                <a href="/shop-kits" style={{ color: "var(--cb-purple)", fontWeight: 500 }}>Shop Kits</a>
                <span style={{ color: "var(--cb-ink-soft)" }}>/</span>
                    ...
                    <div className="cb-gallery">
                        ...
                        <div className="cb-gallery-thumbs" role="list" aria-label="Kit photo gallery">
                            {galleryImages.map((g, i) => (
                                ...
                                >
                                    <Image src={g.src} alt="" width={300} height={300} unoptimized={true} priority={i === 0} sizes="(max-width: 768px) 25vw, 15vw" className="object-cover w-full h-full" />
                                </button>
                            ))}
                        </div>
                    </div>
