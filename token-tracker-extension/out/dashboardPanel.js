...
class DashboardPanel {
    constructor(panel, extensionUri, antigravityTracker, claudeTracker) {
        this.antigravityTracker = antigravityTracker;
    ...
    static createOrShow(context, antigravityTracker, claudeTracker) {
        ...
        const panel = vscode.window.createWebviewPanel('aiTokenTracker', 'AI Token Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [vscode.Uri.joinPath(context.extensionUri, 'media')]
        });
        DashboardPanel.currentPanel = new DashboardPanel(panel, context.extensionUri, antigravityTracker, claudeTracker);
    }
    static async updateIfVisible(antigravityTracker, claudeTracker) {
    ...
    _getHtmlForWebview(webview, agyData, claudeData) {
        ...
        const claudeBudget = config.get('claude.monthlyBudget', 100);
